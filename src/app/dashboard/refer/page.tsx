      ...
      <Card className="w-full max-w-2xl shadow-lg">
        ...
        <CardContent className="space-y-6">
          <div className="text-center">
            ...
            <div className="my-2 p-4 border-2 border-dashed rounded-lg bg-secondary/50">
        ...
        <CardContent className="space-y-4 text-left">
            ...
            <div className="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">Your friend signs up using your code and instantly receives a <span className="font-bold text-primary">₹5 bonus</span>.</p>
                </div>
            </div>
            <div className="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">Once your friend watches 50 ads, you'll receive a <span className="font-bold text-primary">₹5 bonus</span> in your wallet as a thank you!</p>
                </div>
            </div>
        </CardContent>
      </Card>
